...
```
##                      Chromosome Start Stop Gene Strand   PCT_AT   PCT_GC NUM_A
## 1 gi|556503834|ref|NC_000913.3|   337 2799 thrA      + 0.469131 0.530869   552
## 2 gi|556503834|ref|NC_000913.3|  2801 3733 thrB      + 0.436695 0.563305   194
## 3 gi|556503834|ref|NC_000913.3|  3734 5020 thrC      + 0.471229 0.528771   304
## 4 gi|556503834|ref|NC_000913.3|  5683 6459 yaaA      - 0.502577 0.497423   187
## 5 gi|556503834|ref|NC_000913.3|  6529 7959 yaaJ      - 0.466434 0.533566   409
## 6 gi|556503834|ref|NC_000913.3|  8238 9191 talB      + 0.479538 0.520462   251
...
##   BasesCovered FractionCoverage       Depth   PCT_AT   PCT_GC NUM_A NUM_C NUM_G
## 1          909        0.9753219   4.9645925 0.436695 0.563305   194   231   294
## 2         1201        0.4878148   2.3484972 0.469131 0.530869   552   615   692
## 3          744        0.5785381   0.9191291 0.471229 0.528771   304   316   364
## 4          776        1.0000000 576.2500000 0.502577 0.497423   187   197   189
## 5         1430        1.0000000  12.4909086 0.466434 0.533566   409   394   369
## 6          953        1.0000000  10.3084993 0.479538 0.520462   251   241   255
...
ROCplot <- ggplot(filteredDataTNT, aes(d = D, m = M)) + geom_roc(n.cuts = 0, color = "blue")+
  ...
  #+style_roc()
theme(axis.title.y = element_text(face="bold", colour="black", size=6),axis.text.y  = element_text(vjust=0.5, size=6),
axis.title.x =element_text(face="bold", colour="black", size=6),axis.text.x  = element_text(vjust=0.5, size=6))+
...
![](latestRMDlasso_files/figure-docx/unnamed-chunk-9-1.png)<!-- -->
...
axis.text.x  = element_text(angle=90, vjust=0.5, size=6), axis.text.y  = element_text(size=6))+
